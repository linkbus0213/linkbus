...
const cautionSections = [
  ...
  { title: '지원금 안내', items: [
    ...
    '실사용 조건은 개통 후 186일 동안 발신통화 월 5회 이상, 총 통화시간 15분 이상 사용 조건을 기준으로 확인합니다.',
    '186일 이전 요금제 하향, 해지, 정지, 명의변경, 번호이동 등 약정 위반 사유가 발생하면 링크버스 추가지원금과 통신사 공통지원금/추가지원금에 대한 할인반환금이 청구됩니다.',
  ...
  { title: '요금제/개통 안내', items: [
    ...
    '기존 단말기의 위약금 및 잔여할부금은 링크버스에서 조회할 수 없으며 책임지지 않습니다. 각 통신사 고객센터 114로 직접 확인해야 합니다.',
