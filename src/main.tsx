...
const cautionSections = [
  { title: '공통 안내', items: [
    '휴대폰 구매 조건, 출고가, 공통지원금, 추가지원금은 통신사 정책과 링크버스 판매 정책에 따라 개통 전까지 변경될 수 있습니다. 변경 시 개통 전 반드시 안내합니다.',
    '링크버스에서 안내하는 할인 및 추가지원금은 개통 조건, 요금제, 가입유형, 유지기간을 전제로 적용됩니다.',
    '일부 요금제는 가입은 가능하더라도 링크버스 할인 및 추가지원금 적용 대상에서 제외됩니다.',
    '휴대폰은 실사용 목적에 따라 신청 및 개통해야 합니다. 수령 및 개통 후 미사용, 불법 목적, 악의적 목적의 개통이 확인되면 링크버스가 제공한 할인 및 추가지원금 전액 반환 및 손해배상 청구 대상입니다.',
    '명의도용, 허위 신청, 대리 신청, 부정 개통, 개통 사기 의심 건은 접수 또는 개통이 불가하며 확인 즉시 취소됩니다.',
    '미성년자가 물품을 구매하는 경우 취소는 법정대리인만 가능합니다. 단, 법정대리인 동의 없이 체결한 계약은 미성년자 본인 또는 법정대리인이 취소할 수 있습니다.',
  ] },
  { title: '지원금 안내', items: [
    '약정기간은 기본 24개월입니다. 일부 모델 또는 통신사 정책에 따라 12개월 약정 조건이 별도 적용될 수 있습니다.',
    '개통 후 186일 이내(SK 일부 기준은 285일 이내) 해지, 정지, 일시정지, 해외정지, 명의변경, 다른 기기로 기기변경, 유심기변, 타 통신사 이동, 실사용 조건 미충족이 발생하면 링크버스가 제공한 할인 및 추가지원금 전액 반환 대상입니다.',
    '실사용 조건은 개통 후 186일 동안 발신통화 월 5회 이상, 월 통화시간 15분 이상 사용 조건을 기준으로 확인합니다.',
    '186일 이전 요금제 하향, 해지, 정지, 명의변경, 번호이동, 유심기변 등 약정 위반 사유가 발생하면 링크버스 추가지원금과 통신사 공통지원금/추가지원금에 대한 할인반환금이 청구됩니다.',
    '공통지원금과 추가지원금은 통신사 및 판매 정책에 따라 수시로 변경됩니다. 정책 변경 전 안내받은 금액은 개통 완료 전까지 확정 금액이 아닙니다.',
    '지원금 적용 여부는 가입유형, 통신사, 요금제, 재고, 고객 회선 상태에 따라 달라집니다.',
  ] },
  { title: '선택약정 요금할인 안내', items: [
    '선택약정은 요금제 기본료의 25%를 할인받는 방식이며, 공통지원금 할인과 중복 적용되지 않습니다.',
    '공통지원금 할인과 선택약정 요금할인 중 어느 방식이 유리한지는 단말기 가격, 요금제, 약정기간, 통신사 정책에 따라 달라집니다.',
    '선택약정 할인 금액은 선택한 요금제 월정액 기준으로 산정되며, 요금제 변경 시 할인 금액도 변경됩니다.',
    '선택약정 약정기간 중 해지, 번호이동, 명의변경, 약정 승계 불가 사유가 발생하면 통신사 기준에 따라 할인반환금이 청구됩니다.',
    '선택약정 유지기간 및 위약금은 통신사 고객센터 114 또는 공식 신청서에서 반드시 직접 확인해야 합니다.',
  ] },
  { title: '요금제/개통 안내', items: [
    '개통 당시 선택한 요금제 유지기간은 186일입니다. 유지기간 이전에는 요금제 하향이 불가합니다.',
    '유지기간 이전에는 5G 요금제와 LTE 요금제 간 변경이 불가합니다.',
    '개통 후 186일 이내에는 유심기변이 불가합니다. 유심기변 적발 시 링크버스 할인 및 추가지원금 전액 반환 대상입니다.',
    '유지기간 이후 요금제 하향은 통신사별 기준 이하로 변경할 수 없습니다. 5G 단말은 SK 42,000원, KT/LG 47,000원 기본료까지만 가능하며, LTE 단말은 SK 20,000원, KT 20,000원, LG 26,400원 기본료까지만 가능합니다.',
    '위 기준보다 낮은 요금제로 변경하면 할인반환금이 청구됩니다.',
    '현재 선불폰 이용 중인 경우 진행이 불가합니다.',
    '직전 개통일 186일 이내에는 개통이 불가합니다. 알뜰폰 사용자는 별도 확인이 필요합니다.',
    'KT/LG 기기변경은 직전 개통일 12개월 이내 진행이 불가합니다. 별도 안내된 경우 추가금 발생 동의 후 진행될 수 있습니다.',
    '요금 체납 및 미납이 있는 경우 개통이 불가합니다. 통신사 고객센터 114를 통해 수납 완료 후 진행해야 합니다.',
    '개인 신용상태에 따라 할부 회선, 가입 회선, 할부 한도가 부족하거나 할부 자체가 불가하면 개통이 불가합니다. 할부 한도는 서울보증보험을 통해 직접 확인해야 합니다.',
    'SK 가입 시 개통자와 동일 명의의 SK 해지 이력이 30일 이내에 있으면 진행이 불가하며, 30일 이후부터 진행 가능합니다.',
    '기존 단말기의 위약금 및 잔여할부금은 고객이 각 통신사 고객센터 114로 직접 조회해야 합니다. 링크버스는 위약금·잔여할부금 조회가 불가하며, 미확인으로 발생한 비용에 대해 책임지지 않습니다.',
    '기존 통신사 위약금은 익월 요금에 합산 청구되며, 잔여할부금은 기존 통신사에서 계속 청구됩니다. 완납 요청은 기존 통신사 고객센터로 직접 요청해야 합니다.',
    '월 중 요금제 변경 시 데이터 및 통화 사용량에 따라 일할 계산 초과요금이 발생할 수 있습니다.',
    '신규 가입이 불가능한 요금제를 사용 중인 경우 개통이 불가하거나 변경 이후 원복이 불가합니다. 고객센터 114로 직접 확인해야 합니다.',
    '번호이동은 개통 시 기존 사용 통신사가 끊기므로 택배 선발송 후 개통을 진행합니다. 개통 전 단말기 박스 미개봉은 필수입니다.',
    '통신사 정책 변동 또는 심사 지연으로 개통이 지연될 수 있으며, 최대 지연 시 1개월 이상 소요될 수 있습니다.',
    '신규가입 및 기기변경은 접수 당일 해피콜, 온라인 공식 신청서 작성, 선개통 후 발송 순서로 진행됩니다.',
    '기기변경 선개통 시 기존 기기 사용이 중단될 수 있으며, 유심보호서비스 부가서비스 삭제 후 개통됩니다. 수령 후 고객센터 114를 통해 재가입할 수 있습니다.',
  ] },
  { title: '배송/수령 안내', items: [
    '배송은 로젠택배 기준으로 진행하며, 오후 6시 이전 신청 건은 당일 발송을 원칙으로 합니다.',
    '도착 지역 택배 지점, 배송기사님 상황, 통신사 심사, 재고 이동에 따라 익일 배송이 불가할 수 있습니다.',
    '미배송 또는 배송 지연 시 송장 확인 후 지역 택배 지점으로 직접 문의해야 합니다.',
    '번호이동 선발송 건은 개통 전까지 단말기 박스를 반드시 미개봉 상태로 보관해야 합니다.',
    '택배 수령 시 외부 박스 파손이 확인되면 즉시 사진을 남기고 당일 고객센터로 접수해야 합니다.',
    '본인 직접 수령 외 비대면 수령을 선택하는 경우 분실 방지를 위해 배송 내역을 반드시 확인해야 합니다.',
  ] },
  { title: '유심/부가서비스 안내', items: [
    '기기변경은 기존 유심 재사용을 원칙으로 합니다.',
    '신규가입 및 통신사 이동은 USIM 구매 7,700원 또는 eSIM 다운로드 2,750원 비용이 발생합니다.',
    '부가서비스는 개통 후 고객센터 114 또는 통신사 직영대리점에서 별도 가입해야 하며, 링크버스에 요청해도 가입 처리는 불가합니다.',
    '휴대폰 보험은 개통일부터 30~60일 이내 가입 가능하며, 고객센터 114 또는 통신사 직영대리점에서 직접 가입해야 합니다.',
    '결합할인, 복지할인, 가족결합, 유무선결합 등은 개통 후 고객센터 114 또는 통신사 직영대리점에서 직접 가입해야 합니다.',
    '기기변경 시 기존 결합 및 복지할인은 유지되지만, 요금제 변경 또는 회선 변경에 따라 할인율 또는 할인액이 변경될 수 있습니다. 고객센터 114로 직접 확인해야 합니다.',
  ] },
