...
const fallbackPhones: Phone[] = [
  ...
  { id: 'galaxy-s26-ultra', brand: '삼성', series: 'Galaxy S 시리즈', carrier: 'LG', joinType: '번호이동', name: '갤럭시 S26 울트라', subtitle: '256GB · 울트라 성능', image: officialImages.galaxy, price: 530000, rebate: 0, monthly: 95000, support: 880000, badge: '급상승', tag: 'SAMSUNG', isVisible: true, colors: defaultColors(officialImages.galaxy), storages: excelStorageData.s26ultra },
]
const brands: Array<Brand | '전체'> = ['전체', '애플', '삼성', '기타']
const appleSeries = ['애플 제품 전체', 'iPhone 17 시리즈', 'iPhone 16 시리즈']
const samsungSeries = ['삼성 제품 전체', 'Galaxy S 시리즈', 'Galaxy Z 시리즈', 'Galaxy A 시리즈']
...
function normalizeSeriesName(series: string) { return series === 'Galaxy S26 시리즈' ? 'Galaxy S 시리즈' : series }
