...
function Storefront() {
  ...
  return <>
    ...
    <main id="top">
      <section className="hero-slider main-image-hero"><a className="main-banner-image" href="#popular" aria-label="LINKBUS 메인 배너"><img src="/images/linkbus-main-banner.png" alt="LINKBUS 메인 배너" /></a></section>
