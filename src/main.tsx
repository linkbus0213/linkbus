...
type CarrierVisibility = Partial<Record<CarrierKey, boolean>>
type StorageOption = { label: string; price?: number | null; support?: number | null; rebate?: number | null; isVisible?: boolean; saleVisibleByCarrier?: CarrierVisibility; supportByCarrier?: CarrierMoney; rebateByCarrier?: CarrierMoney; rebateByCarrierJoin?: RebateByCarrierJoin; planRebateByCarrier?: PlanRebateByCarrier; visiblePlansByCarrier?: VisiblePlansByCarrier; planSupportByCarrier?: PlanSupportByCarrier; planSupportByCarrierJoin?: PlanSupportByCarrierJoin; newJoinVisibleByCarrier?: NewJoinVisibleByCarrier }
type Phone = {
...
const appleDetailImages = Array.from({ length: 11 }, (_, index) => `/images/apple-iphone-17-pro-detail-${String(index).padStart(2, '0')}.png`)
const appleProSpecImage = '/images/apple-iphone-17-pro-detail-11.png'
const appleBasicDetailImages = [
  'https://www.apple.com/v/iphone-17/e/images/meta/iphone-17_overview__cg0rlzmbhl7m_og.png?202605071557',
  'https://www.apple.com/v/iphone-17-pro/e/images/overview/shared-features/hero_features_left__di6j9fy7r7sm_large.jpg',
...
const samsungUltraDetailImages = [
  ...
  'https://images.samsung.com/sec/smartphones/galaxy-s26-ultra/images/galaxy-s26-ultra-features-space-zoom-start.jpg',
  'https://images.samsung.com/sec/smartphones/galaxy-s26-ultra/images/galaxy-s26-ultra-features-photo-assist-start.jpg',
...
const samsungS26FeatureImages = [
  ...
  'https://images.samsung.com/kdp/cms_task/C20260206010028/57159/5d579f03-fb10-4aba-a442-8e06bf7cd683.jpg?$FB_TYPE_B_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20260206010031/57162/28e9229f-5b76-4eba-8330-903cf33e91d9.jpg?$FB_TYPE_B_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20260206010032/57163/b3c4dc5d-f2f9-4636-b251-6ce6877646a1.jpg?$FB_TYPE_B_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20260207010005/57170/7de06350-97ef-4f3c-b917-3e70d5d99c08.jpg?$FB_TYPE_A_JPG$',
  ...
  'https://images.samsung.com/kdp/cms_task/C20260207010010/57175/a9e806e5-61d2-4eb3-830b-b7fd1cbe5ebc.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20260207010009/57174/fb3b169d-efe6-41ee-9fb1-ec4a4792ae0a.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20260219010011/57375/2db0de3b-a770-4056-b586-9443dd462da8.jpg?$FB_TYPE_B_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20260219010010/57374/5357645d-d4fa-4398-a923-8da05e001de1.jpg?$FB_TYPE_B_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20260316000046/58351/c02bb5e8-ff1c-4c06-a71f-573c7bf495db.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20260506000071/59414/ca8a19aa-1e24-4bf6-87d5-be5fbf7d34c7.jpg?$FB_TYPE_B_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20260207010014/57179/545ea53a-d680-4689-82a1-8550a620cd5d.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20260207010015/57180/40de2e7e-af3b-4f37-964c-91e6ab1905e1.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/static/pd/smartphone/galaxy-s26/SM-S942N_web_21_left.jpg?$FB_TYPE_B_JPG$',
]
const samsungS26PlusFeatureImages = [
...
const samsungZFold7FeatureImages = [
  ...
  'https://images.samsung.com/kdp/static/mkt/smartphones/galaxy-z-fold7/images/galaxy-z-fold7-features-highlights-battery.jpg?imbypass=true',
  'https://images.samsung.com/kdp/static/mkt/smartphones/galaxy-z-fold7/images/galaxy-z-fold7-features-highlights-ai-start.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-fold7/images/galaxy-z-fold7-features-formfactor-off.png?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-fold7/images/galaxy-z-fold7-features-formfactor-on.png?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-fold7/images/galaxy-z-fold7-features-gaming-performance-a-start.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-fold7/images/galaxy-z-fold7-features-storage.jpg?imbypass=true',
  'https://images.samsung.com/kdp/static/mkt/smartphones/galaxy-z-fold7/images/galaxy-z-fold7-features-photo-assist-start.jpg?imbypass=true',
  'https://images.samsung.com/kdp/static/mkt/smartphones/galaxy-z-fold7/images/galaxy-z-fold7-features-gemini-live-start-v2.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-fold7/images/galaxy-z-fold7-features-ecosystem.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-fold7/images/galaxy-z-fold7-features-sustainability.jpg?imbypass=true',
]

const samsungZFlip7FeatureImages = [
  'https://images.samsung.com/kdp/static/pd/smartphone/pd-kv-galaxy-z-flip7-pc-kv-img-v2.jpg',
  'https://images.samsung.com/sec/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-highlights-design-start.jpg?imbypass=true',
  'https://images.samsung.com/kdp/static/mkt/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-highlights-camera.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-highlights-ai-start.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-highlights-battery.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-formfactor-off.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-selfie.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-camera-specs-spec-front.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-camera-specs-spec-rear.png?imbypass=true',
  'https://images.samsung.com/kdp/static/mkt/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-nightography-start.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-nightography.png?imbypass=true',
  'https://images.samsung.com/kdp/static/mkt/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-display-viewing.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-storage.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-now-brief-start.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-now-bar-start.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-gemini-live-start.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-one-ui-visual.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-switch-to-galaxy.jpg?imbypass=true',
  'https://images.samsung.com/kdp/static/mkt/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-ecosystem-a.jpg?imbypass=true',
  'https://images.samsung.com/sec/smartphones/galaxy-z-flip7/images/galaxy-z-flip7-features-sustainability.jpg?imbypass=true',
]
const samsungA17FeatureImages = [
  'https://images.samsung.com/kdp/cms_task/C20251029000031/37133/4fe030d7-70db-489d-92fd-6c7c45c02176.jpg?$ORIGIN_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20251029000032/37134/b95f9948-cb3a-4258-a949-4eb4cb489a04.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20251029000034/37136/4a7dd437-5e44-4313-9ea1-44ad484d794a.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20251029000035/37137/c6bf0d13-c1de-405b-abfa-f2236e928dc3.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20251029000036/37138/fbfa2a63-7948-4e20-bd81-47cbaaecad77.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20251029000037/37139/94c1997c-7a2f-427f-83f7-b458bf10f05f.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20251029000038/37140/18eac863-5cc1-4487-8149-dab4b23cf6ab.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20251029000039/37141/7a304442-4144-46d4-853c-00f755cdfb14.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20251029000040/37142/e15ebc39-29ef-4b42-a5f4-64e8bf2e44c8.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20251029000041/37143/97c43345-db06-4f57-bae2-1488be7530df.jpg?$FB_TYPE_B_JPG$',
  'https://images.samsung.com/kdp/static/pd/smartphone/SM-A175N_web_10_1_column.jpg?$FB_TYPE_L_MO_JPG$',
...
const samsungA36FeatureImages = [
  'https://images.samsung.com/kdp/cms_task/C20250529000080/27478/c3555c24-9c05-492f-9fef-fa28b1669407.jpg?$ORIGIN_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250529000082/27480/374956f3-4dbd-420a-9179-fa5f6ee215d1.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250529000084/27482/3db17394-65d2-4dd7-a716-065e78f8d827.jpg?$ORIGIN_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250529000084/27482/644a500e-56f6-4472-82eb-37f1f262f90e.jpg?$ORIGIN_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250529000084/27482/39aac6d8-f647-41f8-94df-f0ac382f8a0e.jpg?$ORIGIN_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250529000086/27484/d150c067-7d51-4df7-b143-6237474a4b63.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250529000087/27485/6cb08129-51ff-4ae9-9809-e70f5d4cbf76.jpg?$FB_TYPE_B_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250529000089/27487/4b5f88f9-73f8-4064-b8e8-f5671d3b6a79.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250610000211/27609/3dd01dc2-d34b-46e7-9776-97e3c95995b4.jpg?$FB_TYPE_B_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250610000212/27610/25a78929-6eea-40c7-9800-96ce066b40fc.jpg?$FB_TYPE_B_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250529000093/27491/7b9e693b-5c9f-4068-80b2-b99b1a84973b.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250529000094/27492/15372546-6557-4503-8f99-b8a2ca8a15c3.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250529000095/27493/6878d091-3bda-4b3c-8c44-1c9671669292.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250529000096/27494/a75b5b72-72c0-431f-8369-3263a957c797.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250529000097/27495/61ee248d-b093-4866-b647-a560f8ff674c.jpg?$FB_TYPE_B_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250529000098/27496/1d85d749-5dff-4f17-a282-640c322cf48e.jpg?$ORIGIN_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250529000099/27497/22387397-d145-4691-85b5-3f425a5c0496.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/static/pd/smartphone/SM-A366N_mo_12_1.jpg',
  'https://images.samsung.com/kdp/static/pd/smartphone/SM-A366N_mo_12_2.jpg',
  'https://images.samsung.com/kdp/static/pd/smartphone/SM-A366N_mo_12_3.jpg',
]
const samsungQuantum6FeatureImages = [
  'https://images.samsung.com/kdp/cms_task/C20250724000059/35464/fb7d4b7a-a031-4597-b356-0ab8fa965432.jpg?$ORIGIN_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250724000061/35466/726d07b3-f4fd-4ad8-b1b9-5615d2864e7e.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250724000064/35469/e0c2ac6d-9f1e-41f4-a78e-ee3cb7a8ce2c.jpg?$FB_TYPE_B_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250724000063/35468/47333a91-eb14-4a91-8979-3b5122719ce4.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250724000066/35471/77c42be5-2ab9-40d7-bfca-c4825d41ddfe.jpg?$ORIGIN_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250724000067/35472/01e8f85d-f00b-47f0-85cd-5e8a05757f1d.jpg?$ORIGIN_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250724000068/35473/b1227a0d-caf3-4435-85ac-44836747e127.jpg?$ORIGIN_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250724000069/35474/34b5ca6c-8b30-4b38-ac90-ac7a7b85f9ec.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250724000077/35482/f07321b4-969d-4243-b96e-7a62e45b9d17.jpg?$FB_TYPE_B_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250724000074/35479/577d868f-0271-452a-ad37-a6482c052562.jpg?$ORIGIN_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250724000076/35481/a291b2a6-9812-4c43-93d7-d726b166c874.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250724000078/35483/1cb93d4b-763d-44d0-9094-71ae69d4b857.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250724000080/35485/b3f321f7-9b1e-4866-af9a-6fbbb0fcbe52.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/cms_task/C20250724000081/35486/7e4c2514-379e-4bca-b6fa-a2bf42e9aa86.jpg?$FB_TYPE_A_JPG$',
  'https://images.samsung.com/kdp/static/pd/smartphone/SM-A566S_web_15_1_column.jpg?$FB_TYPE_L_PNG$',
  'https://images.samsung.com/kdp/static/pd/smartphone/SM-A566S_web_15_2_column.jpg?$FB_TYPE_L_PNG$',
  'https://images.samsung.com/kdp/static/pd/smartphone/SM-A566S_web_16_1_column.jpg?$FB_TYPE_L_PNG$',
  'https://images.samsung.com/kdp/static/pd/smartphone/SM-A566S_web_16_2_column.jpg?$FB_TYPE_L_PNG$',
  'https://images.samsung.com/kdp/static/pd/smartphone/SM-A566S_web_16_3_column.jpg?$FB_TYPE_L_PNG$',
]
...
function cleanStorages(storages?: StorageOption[] | null) { return storages?.length ? storages.filter(s => s.label).map(s => ({ label: s.label, price: s.price ?? null, support: s.support ?? null, rebate: s.rebate ?? null, isVisible: s.isVisible ?? true, saleVisibleByCarrier: s.saleVisibleByCarrier || {}, supportByCarrier: s.supportByCarrier || {}, rebateByCarrier: s.rebateByCarrier || {}, rebateByCarrierJoin: s.rebateByCarrierJoin || {}, planRebateByCarrier: s.planRebateByCarrier || {}, visiblePlansByCarrier: s.visiblePlansByCarrier || {}, planSupportByCarrier: s.planSupportByCarrier || {}, planSupportByCarrierJoin: s.planSupportByCarrierJoin || {}, newJoinVisibleByCarrier: s.newJoinVisibleByCarrier || {} })) : defaultStorages }
...
function HeaderNav({ simple = false }: { simple?: boolean }) { const ticker = ['LINKBUS 휴대폰 구매 상담 OPEN', '전 통신사 조건 비교', '최저가 상담 신청 가능', '안전한 개통 절차 안내']; return <header className="topbar"><div className="notice-ticker"><div className="ticker-track">{[...ticker, ...ticker].map((text, i) => <span key={`${text}-${i}`}>{text}</span>)}</div></div><div className="top-inner"><a className="brand-logo logo-image" href="/" aria-label="LINKBUS 홈"><img src="/images/linkbus-ci.png" alt="LINKBUS" /></a></div><nav className="menu-line"><a href="/#popular">상품목록</a><a href="/#consult">상담신청</a>{simple ? <a href="/">홈으로</a> : <><a href="/business-info">사업자정보</a><a href="/terms">이용약관</a><a href="/privacy">개인정보처리방침</a><a href="/refund">교환/반품/환불</a></>}</nav></header> }
type StorePage = 'home' | 'apple' | 'samsung' | 'kids' | 'sim' | 'used' | 'reviews' | 'customer'
const mainNavItems: Array<{ page: StorePage; label: string; href: string }> = [
  ...
  { page: 'kids', label: '키즈폰', href: '/kids-phone' },
...
function App() { const path = location.pathname; if (path.startsWith('/admin')) return <AdminApp />; if (path.startsWith('/product/')) return <ProductPage />; if (path === '/terms') return <LegalPage kind="terms" />; if (path === '/privacy') return <LegalPage kind="privacy" />; if (path === '/refund') return <LegalPage kind="refund" />; if (path === '/business-info') return <LegalPage kind="business" />; if (path === '/apple') return <Storefront page="apple" />; if (path === '/samsung') return <Storefront page="samsung" />; if (path === '/kids-phone') return <Storefront page="kids" />; if (path === '/sim-only') return <Storefront page="sim" />; if (path === '/used-phone') return <Storefront page="used" />; if (path === '/reviews') return <Storefront page="reviews" />; if (path === '/customer-center') return <Storefront page="customer" />; return <Storefront /> }

function Storefront({ page = 'home' }: { page?: StorePage }) {
  const [phones, setPhones] = useState<Phone[]>(fallbackPhones)
  const initialBrand: Brand | '전체' = page === 'apple' ? '애플' : page === 'samsung' ? '삼성' : page === 'kids' ? '기타' : '전체'
  const initialSeries = page === 'samsung' ? samsungSeries[0] : page === 'apple' ? appleSeries[0] : page === 'kids' ? '기타모델' : appleSeries[0]
  ...
  React.useEffect(() => { const title = page === 'apple' ? '애플 최대할인구매' : page === 'samsung' ? '삼성 최대할인구매' : page === 'kids' ? '키즈폰' : page === 'sim' ? '유심만개통' : page === 'used' ? '중고폰판매' : page === 'reviews' ? '리얼후기' : page === 'customer' ? '고객센터' : '휴대폰 구매 상담'; document.title = `링크버스 | ${title}` }, [page])
  const seriesList = brand === '삼성' ? samsungSeries : brand === '기타' ? kidsSeries : appleSeries
  const filtered = useMemo(() => sortPhonesForDisplay(phones.filter((phone) => { const pageBrand = page === 'apple' ? '애플' : page === 'samsung' ? '삼성' : page === 'kids' ? '기타' : null; const activeBrand = pageBrand || (brand === '전체' ? null : brand); const isBrandAll = !activeBrand; const isSeriesAll = series === '애플 제품 전체' || series === '삼성 제품 전체' || series === '키즈폰 전체' || page === 'kids'; const brandOk = activeBrand ? phone.brand === activeBrand : true; const seriesOk = isBrandAll || isSeriesAll || phone.series === series; const simOk = page === 'sim' ? (phone.carrier === '알뜰폰' || phone.tag?.includes('유심') || phone.subtitle?.includes('유심')) : true; return brandOk && seriesOk && simOk })), [phones, brand, series, page])
  function chooseBrand(next: Brand | '전체') { setBrand(next); setSeries(next === '삼성' ? samsungSeries[0] : next === '애플' ? appleSeries[0] : next === '기타' ? kidsSeries[0] : appleSeries[0]) }
  const title = page === 'apple' ? '애플 최대할인구매' : page === 'samsung' ? '삼성 최대할인구매' : page === 'kids' ? '키즈폰' : page === 'sim' ? '유심만개통' : page === 'used' ? '중고폰판매' : page === 'reviews' ? '리얼후기' : page === 'customer' ? '고객센터' : '최대할인구매'
  const subtitle = page === 'apple' ? '아이폰 모델별 출고가·할인·현재가격을 한눈에 확인하세요.' : page === 'samsung' ? '갤럭시 모델별 최대 할인 조건을 확인하세요.' : page === 'kids' ? '어린이와 보호자를 위한 키즈폰 상품을 모아 확인하세요.' : page === 'sim' ? '사용 중인 단말기는 그대로, 유심과 요금제만 상담합니다.' : page === 'used' ? '쓰던 휴대폰 판매 상담을 위한 전용 안내 페이지입니다.' : page === 'reviews' ? 'LINKBUS 이용 고객의 실제 후기를 모아 보여드릴 공간입니다.' : page === 'customer' ? '상담 가능 시간과 문의 방법을 안내드립니다.' : 'LINKBUS에서 준비한 휴대폰 최대 할인 구매 상품입니다.'
  return <><MainHeader active={page} /><main id="top">{page === 'home' ? <><section className="hero-slider main-image-hero"><a className="main-banner-image" href="#popular" aria-label="LINKBUS 메인 배너"><img src="/images/linkbus-main-banner.png" alt="LINKBUS 메인 배너" /></a><div className="brand-shortcut-row"><a className="brand-shortcut apple" href="/apple"><span>APPLE</span><b>애플 제품 바로가기</b><img src={officialImages.iphonePro} alt="애플 제품" /></a><a className="brand-shortcut samsung" href="/samsung"><span>SAMSUNG</span><b>삼성 제품 바로가기</b><img src={officialImages.galaxy} alt="삼성 제품" /></a></div></section><section id="popular" className="popular-section new-phone-section"><div className="section-title"><h2>최대할인구매</h2></div><div className="brand-tabs">{brands.map((item) => <button key={item} className={brand === item ? 'active' : ''} onClick={() => chooseBrand(item)}>{item === '애플' ? '애플 | APPLE' : item === '삼성' ? '삼성 | SAMSUNG' : item === '기타' ? '키즈폰' : item}</button>)}</div>{brand !== '전체' && <div className="series-tabs">{seriesList.map((item) => <button key={item} className={series === item ? 'active' : ''} onClick={() => setSeries(item)}>{item}</button>)}</div>}<div className="phone-strip new-phone-grid">{filtered.map((phone) => <ProductTile key={phone.id} phone={phone} />)}{!filtered.length && <p className="empty">등록된 상품이 없습니다. 상담으로 조건을 확인해 주세요.</p>}</div></section></> : <section className="standalone-page"><PageHero title={title} subtitle={subtitle} page={page} />{page === 'reviews' ? <ReviewsPage embedded /> : page === 'customer' ? <CustomerCenterPage embedded /> : page === 'used' ? <UsedPhonePage embedded /> : page === 'kids' ? <ProductGrid phones={filtered} emptyText="키즈폰 상품은 준비 중입니다. 고객센터로 문의해 주세요." /> : page === 'sim' ? <><ProductGrid phones={filtered} emptyText="유심만개통 상품은 준비 중입니다. 고객센터로 문의해 주세요." /><InfoGuide title="유심만개통 안내" items={['사용 중인 단말기는 그대로 두고 유심/요금제만 개통 상담을 진행합니다.', '통신사, 요금제, 번호이동/신규가입 가능 여부를 확인한 뒤 안내합니다.', '상담 신청 또는 고객센터로 연락 주시면 가능한 조건을 확인해드립니다.']} /></> : <><div className="series-tabs page-series-tabs">{(page === 'apple' ? appleSeries : page === 'samsung' ? samsungSeries : []).map((item) => <button key={item} className={series === item ? 'active' : ''} onClick={() => setSeries(item)}>{item}</button>)}</div><ProductGrid phones={filtered} /></>}</section>}</main><SiteFooter /></>
}
function PageHero({ title, subtitle, page }: { title: string; subtitle: string; page: StorePage }) { return <div className={`page-hero page-${page}`}><img className="page-hero-character" src="/images/linkbus-character-ci.png" alt="LINKBUS 캐릭터" /><span>LINKBUS</span><h1>{title}</h1><p>{subtitle}</p></div> }
function ProductGrid({ phones, emptyText = '등록된 상품이 없습니다. 상담으로 조건을 확인해 주세요.' }: { phones: Phone[]; emptyText?: string }) { return <div className="phone-strip new-phone-grid page-product-grid">{phones.map((phone) => <ProductTile key={phone.id} phone={phone} />)}{!phones.length && <p className="empty">{emptyText}</p>}</div> }

function ReviewsPage({ embedded = false }: { embedded?: boolean }) { return <section className={embedded ? 'info-page embedded-info-page' : 'info-page'}><div className="section-title"><h2>리얼후기</h2><p>LINKBUS 이용 고객의 실제 후기를 확인하는 공간입니다.</p></div><div className="review-only-grid"><article><b>등록된 후기가 없습니다.</b><p>구매 후기가 등록되면 이 페이지에서 상품별 후기를 보여드릴게요.</p></article><article><b>후기 작성 안내</b><p>회원가입/로그인 후 구매 고객이 직접 후기를 남길 수 있도록 준비 중입니다.</p></article></div></section> }
function CustomerCenterPage({ embedded = false }: { embedded?: boolean }) { return <section className={embedded ? 'info-page embedded-info-page' : 'info-page'}><div className="section-title"><h2>고객센터</h2><p>상담 가능 시간과 문의 방법을 안내드립니다.</p></div><div className="customer-center-card"><h3>LINKBUS 고객센터</h3><strong>{BUSINESS_INFO.customerCenter}</strong><p>{BUSINESS_INFO.hours}</p><ul><li>휴대폰 구매 조건 상담</li><li>개통 절차 및 배송 안내</li><li>교환·반품·환불 기준 안내</li><li>상품 후기/문의 처리</li></ul><a className="legal-button" href={kakaoHref('LINKBUS 고객센터 문의')}>카카오톡 상담하기</a></div></section> }
function UsedPhonePage({ embedded = false }: { embedded?: boolean }) { return <section className={embedded ? 'info-page embedded-info-page' : 'info-page'}><div className="section-title"><h2>중고폰판매</h2><p>사용하던 휴대폰 판매 상담을 준비 중입니다.</p></div><div className="customer-center-card"><h3>중고폰 판매 상담</h3><p>모델명, 용량, 색상, 외관 상태, 배터리 상태, 구성품 여부를 확인한 뒤 매입 가능 여부와 예상 금액을 안내합니다.</p><ul><li>정상해지/분실·도난 여부 확인 필요</li><li>액정 파손, 침수, 기능 이상 여부 확인</li><li>상태 확인 후 최종 금액 확정</li></ul><a className="legal-button" href={kakaoHref('중고폰 판매 상담')}>중고폰 판매 상담하기</a></div></section> }
...
function AdminShell({ children }: { children: React.ReactNode }) { return <main className="admin-page"><a className="brand-logo logo-image" href="/" aria-label="LINKBUS 홈"><img src="/images/linkbus-ci.png" alt="LINKBUS" /></a>{children}</main> }
...
const blankPhone: Phone = { id: '', brand: '애플', series: '아이폰 17 시리즈', carrier: 'SK', joinType: '번호이동', name: '', subtitle: '', image: officialImages.iphone, price: null, rebate: null, monthly: 0, support: 0, badge: '추천', tag: 'APPLE', isVisible: true, colors: [{ name: '블랙', hex: '#1f2329', image: officialImages.iphone }], storages: defaultStorages }
const adminTagOptions = ['APPLE', 'SAMSUNG', '기타모델', '유심만개통']
const clonePhoneForNewModel = (phone: Phone): Phone => JSON.parse(JSON.stringify({ ...phone, id: '', name: `${phone.name} 복사본`, isVisible: false }))
function AdminPanel({ onLogout }: { onLogout: () => void }) {
  const [products, setProducts] = useState<Phone[]>([]), [editing, setEditing] = useState<Phone>(blankPhone), [conditionEditing, setConditionEditing] = useState<Phone | null>(null), [message, setMessage] = useState(''), [uploading, setUploading] = useState(false), [bulkProducts, setBulkProducts] = useState<Phone[]>([])
  ...
  React.useEffect(() => { setBulkProducts(JSON.parse(JSON.stringify(products))) }, [products])
  ...
  const editModel = (p: Phone) => { setEditing(JSON.parse(JSON.stringify(p))); setConditionEditing(null); setMessage('모델 기본정보를 수정합니다.') }
  const editConditions = (p: Phone) => { setConditionEditing(JSON.parse(JSON.stringify(p))); setEditing(blankPhone); setMessage('선택한 모델의 출고가/지원금/리베이트 조건을 입력합니다.') }
  const cloneModel = (p: Phone) => { setEditing(clonePhoneForNewModel(p)); setConditionEditing(null); setMessage('기존 모델을 복사했습니다. 모델명 등 필요한 항목만 수정한 뒤 저장하면 새 모델로 추가됩니다.') }
  async function saveBulkConditions(nextProducts = bulkProducts) { setMessage('일괄 조건 저장 중...'); const targets = nextProducts.filter((p) => p.id); const results = await Promise.all(targets.map((p) => supabase!.from('sale_products').update(phoneToRow(p)).eq('id', p.id))); const failed = results.find((r) => r.error); if (failed?.error) { setMessage(`일괄 조건 저장 실패: ${failed.error.message}`); return } setMessage('모델별 통신사 판매/요금제별 리베이트 저장 완료'); load() }
  return <AdminShell><div className="admin-head"><div><h1>상품 관리자</h1><p>모델 등록은 기본정보만 입력하고, 출고가·공통지원금·리베이트는 등록된 모델을 선택해서 따로 입력합니다.</p></div><button onClick={onLogout}>로그아웃</button></div><section className="admin-grid separated-admin-grid"><form className="admin-card product-form model-form" onSubmit={saveModel}><div className="admin-card-title"><span>{editing.id ? '모델 기본정보 수정' : '모델 등록'}</span><small>기존 모델을 복사하면 이미지·색상·저장공간/판매조건을 그대로 불러와 일부 항목만 바꿔 새 모델로 추가할 수 있습니다.</small></div><label className="clone-model-select">기존 모델 복사<select value="" onChange={(e) => { const target = products.find((p) => p.id === e.target.value); if (target) cloneModel(target) }}><option value="">복사할 모델 선택</option>{products.map((p) => <option key={p.id} value={p.id}>{p.name} · {p.brand} · {p.series}</option>)}</select></label><AdminInput label="모델명" value={editing.name} onChange={(v) => setEditing({ ...editing, name: v })} required /><AdminInput label="설명" value={editing.subtitle} onChange={(v) => setEditing({ ...editing, subtitle: v })} /><label>제조사<select value={editing.brand} onChange={(e) => setEditing({ ...editing, brand: e.target.value as Brand, series: e.target.value === '삼성' ? samsungSeries[0] : e.target.value === '애플' ? appleSeries[0] : editing.series })}><option>애플</option><option>삼성</option><option>기타</option></select></label><label>시리즈<select value={editing.series} onChange={(e) => setEditing({ ...editing, series: e.target.value })}>{(editing.brand === '삼성' ? samsungSeries : editing.brand === '애플' ? appleSeries : ['기타모델']).map((item) => <option key={item} value={item}>{item}</option>)}</select></label><AdminInput label="배지" value={editing.badge} onChange={(v) => setEditing({ ...editing, badge: v })} /><label>태그<select value={adminTagOptions.includes(editing.tag) ? editing.tag : '기타모델'} onChange={(e) => setEditing({ ...editing, tag: e.target.value })}>{adminTagOptions.map((tag) => <option key={tag} value={tag}>{tag}</option>)}</select></label><ImageUploader image={editing.image} uploading={uploading} onUpload={(file) => uploadImage(file)} /><ColorEditor colors={editing.colors} uploading={uploading} onChange={(colors) => setEditing({ ...editing, colors })} onUpload={uploadImage} /><label className="admin-check"><input type="checkbox" checked={editing.isVisible} onChange={(e) => setEditing({ ...editing, isVisible: e.target.checked })} /> 고객 화면에 노출</label>{message && !conditionEditing && <p className="form-message success">{message}</p>}<button className="admin-primary">모델 저장</button><button type="button" onClick={() => setEditing(blankPhone)}>새 모델 입력</button></form><section className="admin-card condition-card"><div className="admin-card-title"><span>판매조건 · 리베이트 입력</span><small>오른쪽 상품 목록에서 “조건입력”을 누른 뒤 입력하세요.</small></div>{conditionEditing ? <div className="condition-editor"><div className="condition-selected"><img src={conditionEditing.colors[0]?.image || conditionEditing.image} alt=""/><div><b>{conditionEditing.name}</b><small>{conditionEditing.brand} · {conditionEditing.series}</small></div></div><p className="formula-note">출고가, 공통지원금, 요금제 노출, 요금제별 리베이트는 이 영역에서만 관리합니다.</p><StorageEditor storages={conditionEditing.storages} onChange={(storages) => setConditionEditing({ ...conditionEditing, storages })} />{message && <p className="form-message success">{message}</p>}<div className="condition-actions"><button className="admin-primary" type="button" onClick={saveConditions}>조건 저장</button><button type="button" onClick={() => setConditionEditing(null)}>닫기</button></div></div> : <div className="empty-condition"><b>아직 선택된 모델이 없습니다.</b><p>모델을 먼저 등록한 다음, 상품 목록에서 조건입력을 눌러 출고가/지원금/리베이트를 입력하세요.</p></div>}</section><BatchRebateEditor products={bulkProducts.length ? bulkProducts : products} onChange={setBulkProducts} onSave={saveBulkConditions} /><section className="admin-card product-list-card"><h2>상품 목록</h2><div className="admin-list">{products.map((p) => <div className="admin-product-row" key={p.id}><button type="button" className="admin-product-main" onClick={() => editModel(p)}><img src={p.colors[0]?.image || p.image} alt=""/><span><b>{p.name}</b><small>{p.brand} · {p.series} · 색상 {p.colors.length}개 · 용량 {p.storages.length}개</small></span>{!p.isVisible && <i>숨김</i>}</button><div className="admin-product-actions"><button type="button" onClick={() => editModel(p)}>모델수정</button><button type="button" onClick={() => cloneModel(p)}>복사등록</button><button type="button" className="admin-primary small" onClick={() => editConditions(p)}>조건입력</button></div></div>)}</div></section></section></AdminShell>
}

function BatchRebateEditor({ products, onChange, onSave }: { products: Phone[]; onChange: (v: Phone[]) => void; onSave: (v?: Phone[]) => void }) {
  const [selectedId, setSelectedId] = useState('')
  React.useEffect(() => { if (!selectedId && products[0]?.id) setSelectedId(products[0].id) }, [products, selectedId])
  const selectedIndex = Math.max(0, products.findIndex((p) => p.id === selectedId))
  const selected = products[selectedIndex]
  const updateSelected = (patch: Partial<Phone>) => onChange(products.map((p, i) => i === selectedIndex ? { ...p, ...patch } : p))
  const updateStorage = (storageIndex: number, patch: Partial<StorageOption>) => { if (!selected) return; updateSelected({ storages: selected.storages.map((s, i) => i === storageIndex ? { ...s, ...patch } : s) }) }
  const setSaleVisible = (storageIndex: number, carrier: CarrierKey, checked: boolean) => { const storage = selected?.storages[storageIndex]; updateStorage(storageIndex, { saleVisibleByCarrier: { ...(storage?.saleVisibleByCarrier || {}), [carrier]: checked } }) }
  const setNewJoinVisible = (storageIndex: number, carrier: CarrierKey, checked: boolean) => { const storage = selected?.storages[storageIndex]; updateStorage(storageIndex, { newJoinVisibleByCarrier: { ...(storage?.newJoinVisibleByCarrier || {}), [carrier]: checked } }) }
  const setPlanVisible = (storageIndex: number, carrier: CarrierKey, planName: string, checked: boolean) => { const storage = selected?.storages[storageIndex]; const all = storage?.visiblePlansByCarrier || {}; const carrierPlanNames = carrierPlans.filter((p) => p.carrier === carrier).map((p) => p.name); const current = all[carrier] || carrierPlanNames; const next = checked ? Array.from(new Set([...current, planName])) : current.filter((name) => name !== planName); updateStorage(storageIndex, { visiblePlansByCarrier: { ...all, [carrier]: next } }) }
  const setPlanJoinRebate = (storageIndex: number, carrier: CarrierKey, planName: string, joinType: JoinType, value: number | null) => { const storage = selected?.storages[storageIndex]; const all = storage?.planRebateByCarrier || {}; const carrierRows = all[carrier] || {}; const planRows = carrierRows[planName] || {}; updateStorage(storageIndex, { planRebateByCarrier: { ...all, [carrier]: { ...carrierRows, [planName]: { ...planRows, [joinType]: value } } } }) }
  return <section className="admin-card bulk-rebate-card"><div className="admin-card-title"><span>통신사 판매 · 리베이트 일괄 입력</span><small>왼쪽에서 모델을 순서대로 선택하고, 오른쪽에서 통신사 판매 여부와 요금제별 리베이트를 입력합니다.</small></div><div className="bulk-rebate-layout"><div className="bulk-model-list">{products.map((p, idx) => <button type="button" key={p.id || idx} className={p.id === selected?.id ? 'active' : ''} onClick={() => setSelectedId(p.id)}><span>{idx + 1}</span><b>{p.name}</b><small>{p.brand} · {p.series}</small></button>)}</div>{selected ? <div className="bulk-rebate-panel"><div className="condition-selected compact"><img src={selected.colors[0]?.image || selected.image} alt=""/><div><b>{selected.name}</b><small>모델당 신규가입/통신사이동/기기변경 · 3개 통신사 · 요금제별 입력</small></div></div>{selected.storages.map((storage, storageIndex) => <div className="bulk-storage-block" key={`${storage.label}-${storageIndex}`}><div className="bulk-storage-head"><b>{storage.label}</b><span>출고가 {money(storage.price ?? selected.price ?? 0)}</span></div>{carrierKeys.map((carrier) => { const plans = carrierPlans.filter((p) => p.carrier === carrier); const visibleNames = storage.visiblePlansByCarrier?.[carrier] || plans.map((p) => p.name); return <div className="bulk-carrier-block" key={carrier}><div className="bulk-carrier-head"><b>{carrier}</b><label><input type="checkbox" checked={storage.saleVisibleByCarrier?.[carrier] !== false} onChange={(e) => setSaleVisible(storageIndex, carrier, e.target.checked)}/> 판매</label><label><input type="checkbox" checked={storage.newJoinVisibleByCarrier?.[carrier] === true} onChange={(e) => setNewJoinVisible(storageIndex, carrier, e.target.checked)}/> 신규가입 노출</label></div><div className="bulk-plan-table"><div className="bulk-plan-table-head"><span>요금제</span>{joinTypes.map((type) => <span key={type}>{type}</span>)}</div>{plans.map((plan) => <div className="bulk-plan-row" key={plan.name}><label><input type="checkbox" checked={visibleNames.includes(plan.name)} onChange={(e) => setPlanVisible(storageIndex, carrier, plan.name, e.target.checked)}/><span>{plan.name}</span><em>{money(plan.fee)}</em></label>{joinTypes.map((type) => <input key={type} type="number" value={storage.planRebateByCarrier?.[carrier]?.[plan.name]?.[type] ?? ''} onChange={(e) => setPlanJoinRebate(storageIndex, carrier, plan.name, type, e.target.value === '' ? null : Number(e.target.value))} placeholder="리베이트"/> )}</div>)}</div></div> })}</div>)}</div> : <div className="empty-condition"><b>모델이 없습니다.</b><p>먼저 상품을 등록해 주세요.</p></div>}</div><button type="button" className="admin-primary bulk-save" onClick={() => onSave(products)}>현재 일괄 입력 내용 저장</button></section>
}
...
function StorageEditor({ storages, onChange }: { storages: StorageOption[]; onChange: (v: StorageOption[]) => void }) {
  ...
  const setSaleVisible = (index: number, carrier: CarrierKey, checked: boolean) => {
    ...
    setStorage(index, { saleVisibleByCarrier: { ...all, [carrier]: checked } })
  }
...
function HighlightText({ text }: { text: string }) {
  const keywords = [
    '약정기간은 24개월 입니다.',
    '해지 시 위약금 발생',
    '링크버스가 제공한 할인 및 링크버스추가지원금 전액 반환',
    '링크버스가 제공한 할인 및 링크버스추가지원금 전액반환',
...
const cautionSections = [
  { title: '공통 안내', items: [
    '[조건 변경] 휴대폰 구매 조건, 출고가, 공통지원금, 링크버스추가지원금은 통신사 정책과 링크버스 판매 정책에 따라 개통 전까지 변경될 수 있습니다. 변경 시 개통 전 반드시 안내합니다.',
    '[할인 적용 기준] 링크버스에서 안내하는 할인 및 링크버스추가지원금은 개통 조건, 요금제, 가입유형, 유지기간을 전제로 적용됩니다.',
    '[할인 제외] 일부 요금제는 가입은 가능하더라도 링크버스 할인 및 링크버스추가지원금 적용 대상에서 제외됩니다.',
    '[실사용 원칙] 휴대폰은 실사용 목적에 따라 신청 및 개통해야 합니다. 수령 및 개통 후 미사용, 불법 목적, 악의적 목적의 개통이 확인되면 링크버스가 제공한 할인 및 링크버스추가지원금 전액 반환 및 손해배상 청구 대상입니다.',
  ...
  { title: '지원금 안내', items: [
    ...
    '[지원금 반환] 개통 후 186일 이내(SK 일부 기준은 285일 이내) 해지, 정지, 일시정지, 해외정지, 명의변경, 다른 기기로 기기변경, 유심기변, 타 통신사 이동, 실사용 조건 미충족이 발생하면 링크버스가 제공한 할인 및 링크버스추가지원금 전액 반환 대상입니다.',
    '[실사용 조건] 실사용 조건은 개통 후 186일 동안 발신통화 월 5회 이상, 월 통화시간 15분 이상 사용 조건을 기준으로 확인합니다.',
    '[할인반환금] 186일 이전 요금제 하향, 해지, 정지, 명의변경, 번호이동, 유심기변 등 약정 위반 사유가 발생하면 링크버스추가지원금과 통신사 공통지원금/링크버스추가지원금에 대한 할인반환금이 청구됩니다.',
    '[정책 변동] 공통지원금과 링크버스추가지원금은 통신사 및 판매 정책에 따라 수시로 변경됩니다. 정책 변경 전 안내받은 금액은 개통 완료 전까지 확정 금액이 아닙니다.',
  ...
  { title: '요금제/개통 안내', items: [
    ...
    '[유심기변 제한] 개통 후 186일 이내에는 유심기변이 불가합니다. 유심기변 적발 시 링크버스 할인 및 링크버스추가지원금 전액 반환 대상입니다.',
...
function FaceAuthNotice() { return <section className="face-auth-notice"><div><b>안면 인증 단계 추가 안내</b><p>정부 정책에 따라 명의도용 및 부정 가입 방지를 위한 안면 인증 단계가 추가되었습니다.</p><p>신분증 사진과 실제 얼굴 일치 여부를 확인하는 절차입니다.</p></div><strong>시범 서비스 기간인 2026년 6월 30일까지는 오류가 발생해도 정상적으로 신청 가능합니다.</strong></section> }


function ProductOfficialDetails({ phone }: { phone: Phone }) {
  const isSamsung = phone.brand === '삼성'
  const isUltra = /울트라|Ultra/i.test(phone.name)
  const isPlus = /S26\+|S26 플러스|플러스|Plus/i.test(phone.name)
  const isS26 = /S26|에스26/i.test(phone.name) && !isUltra && !isPlus
  ...
  const isA36 = /A36|에이36/i.test(phone.name)
  const isQuantum6 = /퀀텀\s*6|Quantum\s*6|A56/i.test(phone.name)
  const isS25Fe = /S25\s*FE|S25FE|에스25\s*FE/i.test(phone.name)
  const isApplePro = phone.brand === '애플' && /프로|Pro/i.test(phone.name)
  const images = isSamsung ? (isQuantum6 ? samsungQuantum6FeatureImages : isA36 ? samsungA36FeatureImages : isS25Fe ? samsungS25FeFeatureImages : isA17 ? samsungA17FeatureImages : isFlip7 ? samsungZFlip7FeatureImages : isFold7 ? samsungZFold7FeatureImages : isUltra ? samsungUltraDetailImages : isPlus ? samsungS26PlusFeatureImages : isS26 ? samsungS26FeatureImages : samsungDetailImages) : (isApplePro ? appleDetailImages : appleBasicDetailImages)
  const source = (isS26 || isPlus || isUltra || isFold7 || isFlip7 || isA17 || isA36 || isQuantum6 || isS25Fe) ? 'Samsung 공식 홈페이지 특장점' : isSamsung ? 'Samsung 공식 홈페이지' : 'Apple 공식 홈페이지'
  ...
  const isLongOfficialDetail = isApplePro || isS26 || isPlus || isUltra || isFold7 || isFlip7 || isA17 || isA36 || isQuantum6 || isS25Fe
  const specImage = isApplePro ? appleProSpecImage : isQuantum6 ? '/images/samsung-quantum6-spec-full.png' : isA36 ? '/images/samsung-a36-spec-full.png' : isS25Fe ? '/images/samsung-s25-fe-spec-full.png' : isA17 ? '/images/samsung-a17-spec-full.png' : isFlip7 ? '/images/samsung-z-flip7-spec-full.png' : isFold7 ? '/images/samsung-z-fold7-spec-full.png' : isUltra ? '/images/samsung-s26-ultra-spec-full.png' : isPlus ? '/images/samsung-s26-plus-spec-full.png' : '/images/samsung-s26-spec-full.png'
  const visibleImages = isLongOfficialDetail && !detailExpanded ? images.slice(0, 6) : images
  if (isLongOfficialDetail) return <section className={`product-official-detail tdirect-detail ${detailExpanded ? 'expanded' : 'collapsed'}`}><div className="board-title"><div><h3>상품 상세정보</h3></div><strong>{detailExpanded ? `${images.length}장 전체` : '요약보기'}</strong></div><div className="official-detail-long-list">{visibleImages.map((src, index) => <img key={src} src={src} alt={`${phone.name} ${isSamsung ? '삼성전자' : 'Apple'} 공식 상세 이미지 ${index + 1}`} loading="lazy" />)}{detailExpanded && <img className="s26-spec-full-image" src={specImage} alt={`${phone.name} ${isSamsung ? '삼성전자' : 'Apple'} 공식 스펙 및 모델 비교 정보`} loading="lazy" />}</div><div className="detail-more-box"><button type="button" onClick={() => setDetailExpanded(!detailExpanded)}>{detailExpanded ? '상세정보 접기' : '상세정보 더보기'}</button></div><p className="official-detail-note">상세 이미지는 {isSamsung ? '삼성전자' : 'Apple'} 공식 홈페이지 기준이며, 색상·용량·구성품은 선택한 모델 및 판매 조건에 따라 달라질 수 있습니다.</p></section>
...
function ProductDetail({ phone }: { phone: Phone }) {
  ...
  const planDiscountContractTotal = planDiscountAmount * contractMonths
  const supportDiscountTotal = support + rebate
  ...
  const deviceDiscountTotal = discountMode === 'support' ? supportDiscountTotal : 0
  const planDiscountTotal = discountMode === 'plan' ? planDiscountAmount : 0
  const telecomFee = activePlanFee
  ...
  const saleCarrierOptions = saleCarriersForStorage(storage)
  const newJoinCarriers = saleCarrierOptions.filter((carrier) => storage?.newJoinVisibleByCarrier?.[carrier] === true)
  const currentCarrierOptions: Array<CarrierKey | '알뜰폰' | '신규가입'> = ['SKT', 'KT', 'LGU+', '알뜰폰', ...(newJoinCarriers.length ? ['신규가입' as const] : [])]
  const targetCarrierOptions = currentCarrier === '신규가입' ? newJoinCarriers : saleCarrierOptions
  React.useEffect(() => { if (targetCarrierOptions.length && !targetCarrierOptions.includes(targetCarrier)) changeCarrier(targetCarrierOptions[0]) }, [currentCarrier, storageIndex])
  React.useEffect(() => { if (targetCarrier === 'KT' && contractMonths !== 24) setContractMonths(24) }, [targetCarrier, contractMonths])
  const aiCandidates = displayStorages.flatMap((item) => saleCarriersForStorage(item).flatMap((carrier) => visiblePlansForStorage(item, carrier).filter((p) => !aiUnlimited || /무제한|완전/.test(p.data)).map((p) => { const type: JoinType = currentCarrier === '신규가입' ? '신규가입' : currentCarrier === carrier ? '기기변경' : '번호이동'; const itemPrice = item.price ?? phone.price ?? 0; const itemSupport = supportValue(item, carrier, type, item.support ?? phone.support, p.name); const itemRebate = rebateValue(item, carrier, type, phone.rebate, p.name); const itemPrincipal = customerPrincipal(itemPrice, itemSupport, itemRebate); const itemInstallment = installmentPayment(itemPrincipal); return { storage: item, carrier, plan: p, joinType: type, principal: itemPrincipal, installment: itemInstallment, monthly: itemInstallment.monthly + p.fee, support: itemSupport, rebate: itemRebate } })))
  ...
  return <><div className={`sticky-quote-bar ${imageCompact ? 'show' : ''}`}><div><b>{phone.name} {storage?.label || ''}</b><span>{logoLabel(targetCarrier)} · {joinType} · {plan.name} · {discountMode === 'support' ? '공통지원금' : `요금할인 ${contractMonths}개월`}</span></div><div><strong>{money(monthlyBill)}</strong><a href={kakaoHref(phone.name)}>신청하기</a></div></div><section className={`detail-modal phonesawa-like detail-page-card ${imageCompact ? 'image-compact' : ''}`}><div className="detail-left"><div className="detail-phone-title"><h2>{phone.name}</h2><p>{storage?.label || ''} · {color?.name || '기본색상'} · {phone.subtitle}</p></div><div className="modal-media"><img key={selectedImage} src={selectedImage} alt={`${phone.name} ${color?.name || ''}`}/></div><aside className="kt-calc-panel kt-calc-under-image"><div className="kt-calc-product"><b>{phone.name}</b><span>{color?.name || '기본색상'} | {storage?.label || '용량선택'} | {joinType}</span><small>{plan.name}</small></div><dl><dt className="kt-calc-section">기기 할부금</dt><dd className="kt-calc-section"></dd><dt>기기 출고가</dt><dd>{money(devicePrice)}</dd><dt>총 할인액</dt><dd className="discount">-{money(deviceDiscountTotal)}</dd><dt className="sub">ㄴ 단말할인(공통지원금)</dt><dd className="sub">{discountMode === 'support' ? `-${money(support)}` : '0원'}</dd><dt className="sub">ㄴ 링크버스추가지원금</dt><dd className="sub">{discountMode === 'support' ? `-${money(rebate)}` : '0원'}</dd><dt>기기 할부원금</dt><dd>{money(principal)}</dd><dt className="subtotal">기기 할부금 <small>(할부수수료 5.9% 포함)</small></dt><dd className="subtotal">월 {money(installment.monthly)}</dd><dt className="kt-calc-section">통신요금</dt><dd className="kt-calc-section"></dd><dt>요금제 금액</dt><dd>월 {money(plan.fee)}</dd><dt>총 할인액</dt><dd className="discount">{discountMode === 'plan' ? `월 -${money(planDiscountTotal)}` : '0원'}</dd><dt className="sub">ㄴ 요금할인 25%</dt><dd className="sub">{discountMode === 'plan' ? `월 -${money(planDiscountAmount)}` : '월 0원'}</dd><dt className="subtotal">통신요금</dt><dd className="subtotal">월 {money(telecomFee)}</dd></dl><div className="kt-final-price"><span>월 납부금액 총액</span><strong>월 {money(monthlyBill)}</strong><small>월 할부금에 할부수수료 5.9%가 포함되어 있습니다.</small></div></aside></div><div className="detail-right"><div className="option-block tds-option-block"><div className="option-title-line"><h3>색상</h3><span>{color?.name || '기본색상'}</span></div><div className="color-choice-row tds-color-row">{phone.colors.map((c, i) => <button type="button" key={`${c.name}-${i}`} aria-label={c.name} title={c.name} className={i === colorIndex ? 'active' : ''} onClick={() => setColorIndex(i)}><i style={{ background: c.hex }} /></button>)}</div></div><div className="option-block tds-option-block"><div className="option-title-line"><h3>용량</h3><span>출고가 {money(devicePrice)}</span></div><div className="storage-choice-row tds-storage-row">{displayStorages.map((s, i) => <button key={`${s.label}-${i}`} className={i === storageIndex ? 'active' : ''} onClick={() => setStorageIndex(i)}><b>{s.label}</b><small>출고가 {money(s.price ?? phone.price ?? 0)}</small></button>)}</div><div className="support-line tds-price-summary"><span>단말할인(공통지원금) : {money(support)}</span><span>링크버스추가지원금 : {money(rebate)}</span><span>요금할인 : {contractMonths}개월 총 {money(planDiscountContractTotal)}</span><span>고객구매가격 : {money(principal)}</span></div></div><div className="carrier-box logo-carrier-box"><div><b>사용중인통신사</b><div className="carrier-logo-row">{currentCarrierOptions.map((carrier) => <button key={carrier} className={currentCarrier === carrier ? 'active' : ''} onClick={() => setCurrentCarrier(carrier)}><span>{logoLabel(carrier)}</span></button>)}</div></div><div><b>사용하실통신사</b><div className="carrier-logo-row">{targetCarrierOptions.map((carrier) => <button key={carrier} className={targetCarrier === carrier ? 'active' : ''} onClick={() => changeCarrier(carrier)}><span>{logoLabel(carrier)}</span></button>)}</div></div></div><div className="discount-compare-box"><div className="discount-head"><b>할인 방식 선택</b><span>단말할인(공통지원금) vs 요금할인(선택약정)</span></div><div className="discount-mode-grid tds-discount-grid"><button type="button" className={discountMode === 'support' ? 'active' : ''} onClick={() => setDiscountMode('support')}><div><em>추천</em><b>단말할인(공통지원금)</b></div><strong>총 -{money(supportDiscountTotal)}</strong><small>휴대폰 가격을 할인해드려요.</small><small>(1회 할인 / 24개월 기준)</small><span>예상 월 납부 {money(supportMonthlyBill)}</span></button><button type="button" className={discountMode === 'plan' ? 'active' : ''} onClick={() => setDiscountMode('plan')}><div><em>선택</em><b>요금할인(선택약정{contractMonths})</b></div><strong>총 -{money(planDiscountContractTotal)}</strong><small>통신요금을 25% 할인해드려요.</small><small>(-{money(planDiscountAmount)}원 × {contractMonths}개월)</small><span>예상 월 납부 {money(planDiscountMonthlyBill)}</span></button></div><div className="contract-row"><span>요금할인 약정기간</span>{targetCarrier !== 'KT' && <button type="button" className={contractMonths === 12 ? 'active' : ''} onClick={() => { setContractMonths(12); setDiscountMode('plan') }}>12개월</button>}<button type="button" className={contractMonths === 24 ? 'active' : ''} onClick={() => { setContractMonths(24); setDiscountMode('plan') }}>24개월</button>{targetCarrier === 'KT' && <small className="contract-fixed-note">KT는 24개월 선택약정만 진행 가능합니다.</small>}</div><p className="discount-diff"><b>{cheaperMode === 'support' ? '단말할인(공통지원금)' : '요금할인 25%'}</b>이 월 {money(discountDiff)} 더 저렴합니다.</p></div><section className="kt-plan-card"><div className="kt-plan-head"><div><h3>요금제를 선택해 주세요.</h3><p>선택한 요금제를 확인해 주세요.</p></div><button type="button" onClick={() => setPlanOpen(!planOpen)}>{planOpen ? '닫기' : '다른 요금제 선택 +'}</button></div><div className="kt-plan-express"><span>쓰던 번호 · 요금제 · 혜택 그대로 기기만 변경하려면?</span><b>기변 상담</b></div>{planOpen && <div className="td-plan-change-panel"><div className="td-plan-categories">{['추천', '(5G) 5G', '(5G) 청년', '(5G) 시니어', '(LTE) LTE'].map((label, i) => <button type="button" key={label} className={i === 0 ? 'active' : ''}>{label}</button>)}</div><p className="td-plan-note">※ 비노출 요금제는 상담문의 부탁드립니다.</p><div className="td-plan-table"><div className="td-plan-table-head"><span>요금제명</span><span>월정액</span><span>요금제 제공</span><span>요금제 혜택</span></div>{activePlans.map((p) => <button type="button" key={p.name} className={p.name === plan.name ? 'active' : ''} onClick={() => { setPlanName(p.name); setPlanOpen(false) }}><span className="td-plan-name"><b>{p.name}</b>{p.name === plan.name && <em>추천</em>}</span><strong>{money(p.fee)}</strong><span className="td-plan-provide"><small>전화 {p.voice}</small><small>문자 기본제공</small><small>데이터제공량 {p.data}</small></span><span className="td-plan-benefit-list">{p.benefits.map((benefit) => <small key={benefit}>{benefit}</small>)}</span></button>)}</div></div>}<div className="kt-plan-selected"><div><strong>{plan.name}</strong><span>월 {money(plan.fee)}</span></div><ul><li><b>데이터</b><span>{plan.data}</span></li><li><b>공유데이터</b><span>요금제별 제공</span></li><li><b>로밍</b><span>통신사 기준 제공</span></li><li><b>음성/문자</b><span>{plan.voice}</span></li></ul></div><div className="kt-plan-benefits"><b>기본 제공 혜택</b>{plan.benefits.map((benefit) => <span key={benefit}>✓ {benefit}</span>)}</div></section><div className="benefit-condition-grid kt-condition-grid"><div className="condition-zero-box"><div className="condition-zero-head"><span>3無</span><b>추가 조건 없음</b></div><div className="zero-condition-list"><div><i>🚫</i><span>부가서비스 조건</span><strong>없음</strong></div><div><i>💳</i><span>카드 발급 조건</span><strong>없음</strong></div><div><i>📦</i><span>기기 반납 조건</span><strong>없음</strong></div></div><p>선택한 요금제와 가입유형 기준으로만 견적을 안내합니다.</p></div></div><FaceAuthNotice /><div className="ai-quote-box"><div className="ai-quote-head"><div><b>AI 맞춤 견적</b><small>예산과 데이터 성향에 맞춰 최적 조건을 계산해요.</small></div><button type="button" onClick={() => setAiOpen(!aiOpen)}>{aiOpen ? '접기' : 'AI 추천받기'}</button></div>{aiOpen && <div className="ai-quote-body"><label>월 예산<input type="number" value={aiBudget} onChange={(e) => setAiBudget(Number(e.target.value || 0))}/></label><label className="ai-check"><input type="checkbox" checked={aiUnlimited} onChange={(e) => setAiUnlimited(e.target.checked)}/> 무제한/대용량 요금제 우선</label>{aiRecommendation && <div className="ai-result"><span>추천 조합</span><strong>{logoLabel(aiRecommendation.carrier)} · {aiRecommendation.plan.name} · {aiRecommendation.storage.label}</strong><p>예상 월 청구금액 {money(aiRecommendation.monthly)} / 고객구매가격 {money(aiRecommendation.principal)}</p><small>단말할인(공통지원금) {money(aiRecommendation.support)} + 링크버스추가지원금 {money(aiRecommendation.rebate)} 기준으로 계산했어요.</small><button type="button" onClick={() => { const idx = displayStorages.findIndex((item) => item.label === aiRecommendation.storage.label); if (idx >= 0) setStorageIndex(idx); changeCarrier(aiRecommendation.carrier); setPlanName(aiRecommendation.plan.name); setPlanOpen(false); }}>이 조건으로 보기</button></div>}</div>}</div><div className="modal-actions"><a className="kakao-talk" href={kakaoHref(phone.name)}><MessageCircle size={19}/> 카카오톡 상담하기</a><a className="outline" href={kakaoHref(phone.name)}>신청하기</a></div></div></section><div className="detail-board-section"><ProductOfficialDetails phone={phone} /><section className="product-board-card"><div className="board-title"><div><h3>상품 후기</h3><p>구매 후기를 확인해보세요.</p></div><strong>총 0개</strong></div><div className="empty-board"><b>등록된 후기가 없습니다.</b><span>첫 구매 후기가 등록되면 이곳에 표시됩니다.</span></div></section><section className="product-board-card"><div className="board-title"><div><h3>상품 문의</h3><p>궁금한 점을 문의해주세요.</p></div><strong>총 0개</strong></div><div className="board-tabs"><button className="active" type="button">전체</button><button type="button">상태문의</button><button type="button">재고문의</button><button type="button">요금문의</button></div><div className="empty-board"><b>등록된 문의가 없습니다.</b><span>카카오톡 상담하기 또는 신청하기로 문의를 남겨주세요.</span></div></section><section className="phone-caution-card"><CautionText text={purchaseCautionText} /></section></div></>
}
